...
export default function HaveNotStart() {
  ...
  const [picName, setPicName] = useState("Martha");
  const [bonus, setBonus] = useState(3000);
  const [projectBegin, setProjectBegin] = useState(dayjs("2022-08-01"));
  const [projectEnd, setProjectEnd] = useState(dayjs("2023-01-23"));
  const [status, setStatus] = useState("Haven't Start");
        ...
        <form noValidate autoComplete="off" onSubmit={handleSave}>
          ...
          >
            ...
            >
              ...
              <Grid item xs={6}>
                <Typography color="black">Matthias</Typography>
              </Grid>
              <Grid item xs={6}>
                <Typography color="black">Bonus (RM)</Typography>
              </Grid>
              <Grid item xs={6}>
                <Typography color="black">1,200</Typography>
              </Grid>
              <Grid item xs={6}>
              ...
              <Grid item xs={6}>
                <Typography color="black">Have&apos;t Start</Typography>
              </Grid>
            </Grid>
          </Box>
        </form>

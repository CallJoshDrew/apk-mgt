...
export default function Ongoing() {
  const pageTitle = "Construction ABC";

  const [projectName, setProjectName] = useState("Construction ABC");
  const [picName, setPicName] = useState("Simeon");
  const [bonus, setBonus] = useState(1000);
  const [projectBegin, setProjectBegin] = useState(dayjs("2022-08-15"));
  const [projectEnd, setProjectEnd] = useState(dayjs("2023-02-23"));
        ...
        <form noValidate autoComplete="off" onSubmit={handleSave}>
          ...
          >
            ...
            >
              ...
              <Grid item xs={6}>
                <Typography color="black">Ongoing</Typography>
              </Grid>
            </Grid>
          </Box>
        </form>

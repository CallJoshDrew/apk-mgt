...
export default function Terminated() {
  const pageTitle = "Construction YYY";

  const [projectName, setProjectName] = useState("Construction YYY");
  ...
  const [projectEnd, setProjectEnd] = useState(dayjs("2023-02-01"));
  ...
  const handleSave = (e) => {
    e.preventDefault();
    handleClick();
    setTimeout(() => router.push("/notification"), 2000);
  };
  ...
  const [value, setValue] = React.useState([0, 49]);
        ...
        <form noValidate autoComplete="off" onSubmit={handleSave}>
          ...
          >
            ...
            >
              ...
              <Grid item xs={6}>
                <Typography color="black">Sapphira</Typography>
              </Grid>
              <Grid item xs={6}>
                <Typography color="black">Bonus (RM)</Typography>
              </Grid>
              <Grid item xs={6}>
                <Typography color="black">800</Typography>
              </Grid>
              <Grid item xs={6}>
                <Typography color="black">Begin</Typography>
              </Grid>
              <Grid item xs={6}>
                <Typography color="black">08/10/2022</Typography>
              </Grid>
              <Grid item xs={6}>
                <Typography color="black">Completion</Typography>
              </Grid>
              <Grid item xs={6}>
                <Typography color="black">010/01/2022</Typography>
              </Grid>
              <Grid item xs={6}>
              ...
              <Grid item xs={6}>
                <Typography color="black">Terminated</Typography>
              </Grid>
            </Grid>
          </Box>
        </form>
